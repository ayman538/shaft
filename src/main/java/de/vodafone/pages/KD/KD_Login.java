...
public class KD_Login {
    ...
    //*[@class='dip-consent-btn red-btn dip-consent-main-text-btn'])[2]
    //constructor
    public KD_Login(SHAFT.GUI.WebDriver driver) {
        this.driver = driver;
    }

    //keywords
    public KD_Login setCookie(HashMap<String, String> cookieMap) {
    ...
    public KD_Login acceptCookies() {
        driver.element().click(acceptCookies_button);
        return this;
    }

    public KD_Login loginActionST(String userName, String userPassword) {
        ...
        return new KD_Login(driver);
    }

    public KD_Login loginActionSIT(String userName, String userPassword) {
