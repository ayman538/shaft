...
public class EnterprisePairConfirmation {
    private SHAFT.GUI.WebDriver driver;
    public EnterprisePairConfirmation(SHAFT.GUI.WebDriver driver) {
        this.driver = driver;
    }
    ...
    private final String successNotificationContentCL = "Sie bekommen eine Bestätigungs-SMS, wenn Ihr Auto verbunden ist.";
    private final String notificationHeaderCL = "Gut zu wissen";
    private final String notificationContentCL = "Wer im WLAN Ihres Autos surft, nutzt das Datenvolumen Ihres verbundenen Vodafone Tarifs.";
