...
public class DSL_Login {
    // Variables
    private SHAFT.GUI.WebDriver driver;
    //Locators
    private static By STloginButtonLocator = By.xpath("(//button[@class='btn login-btn' and contains(.,'Login')])[1]");;
    private static By STloginUserNameLocator = By.xpath("//input[@id='txtUsername']");
    private static By STloginPasswordLocator = By.xpath("//input[@id='txtPassword']");
    ...
    //constructor
    public DSL_Login(SHAFT.GUI.WebDriver driver) {
        this.driver = driver;
    }

    //keywords
    public DSL_Login setCookie(HashMap<String, String> cookieMap) {
    ...
    public DSL_Login acceptCookies() {
        driver.element().click(acceptCookies_button);
        return this;
    }

    public DSL_Dashboard loginActionST(String userName, String userPassword) {
    ...
    public DSL_Dashboard loginActionSIT(String userName, String userPassword) {
