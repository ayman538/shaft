...
public class WFAT_13952 {
    ...
    @TmsLink("WFAT-14330")
    @Test(description = "Verify landingapage CL")
    private void GC01() {
        new ASPLandingPage(driver).LandingpageCLValidations();
        new ASPLandingPage(driver).TilesValidations();
    }
