...
@Epic("Net Assistant")
@Feature("SIT")
public class WFET_2841 extends SITNetAssistantSetup {
    //Variables
    ...
    @Test(groups={"WFET_2841"})
    @TmsLink("WFET-3204")
    @Description("SIT05- logged in Cable user -verify behavior of logout button at tickets screen")
    private void GC05() {
        new DashboardPage(driver)
                .navigate();
        setCookieECHO();
