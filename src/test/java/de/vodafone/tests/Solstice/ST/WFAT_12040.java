...
@Feature("ST")
@Story("WFAT_12040")
public class WFAT_12040 extends SolsticeSTSetup {
    ...
    @TmsLink("WFAT-12180")
    @Test(description="WFAT-12180-Given I'm a logged in as a Legacy user ,When I open my account management page and click on delete my User account " +
    ...
    @TmsLink("WFAT-12181")
    @Test( description="WFAT-12181-Given I'm a logged in as a Solstice user ,When  I visit the MyVF Account Mgmt area for Login Data " +
    ...
    @TmsLink("WFAT-12182")
    @Test(description="WFAT-12182-Given I'm a logged in as a Solstice user ,When I request the deeplink for User account deletion " +
