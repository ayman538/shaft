package de.vodafone.tests.unityMedia.Tags_SIT;
...
public class SIT_TagsSetup {
    ...
    public void beforeClass() {
        ...
        cookieMap = (HashMap<String, String>) new JSONFileManager(System.getProperty("cookieSwitchersFolderPath") + "UnityMedia/SIT" + "_" + className + "_CookieSwitcher.json").getTestDataAsMap("$");
