...
public class ST_TagsSetup {
    ...
    public void beforeClass() {
        ...
        cookieMap = (HashMap<String, String>) new JSONFileManager(System.getProperty("cookieSwitchersFolderPath") + "UnityMedia/ST" + "_" + className + "_CookieSwitcher.json").getTestDataAsMap("$");
