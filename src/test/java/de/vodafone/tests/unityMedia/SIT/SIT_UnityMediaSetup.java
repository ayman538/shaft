...
public class SIT_UnityMediaSetup {
    ...
    public void beforeClass() {
        cookieMap = (HashMap<String, String>) new JSONFileManager(System.getProperty("cookieSwitchersFolderPath") + "UnityMedia/SIT_DeltaUM_CookieSwitcher.json").getTestDataAsMap("$");
