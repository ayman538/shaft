...
@Feature("ST")
@Story("WFDT_4456")
public class WFDT_4456 extends ST_KableDeutschlandSetup {
    @TmsLink("WFDT-4744")
    @Test(description = "Given I am a KD contract owner When I navigate to meine kundendaten section of my contract Then I should see a new accordion 'Datenschutz&Werbeeinstellungen'together with a smart object",groups = {"eCare"})
    private void gc01() {
