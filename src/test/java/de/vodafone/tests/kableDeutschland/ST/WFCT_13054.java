...
public class WFCT_13054 {
    ...
    public void beforeClass() {
        ...
        cookieMap = (HashMap<String, String>) new JSONFileManager(System.getProperty("cookieSwitchersFolderPath") + "KableDeutschland/ST_WFCT_13054_CookieSwitcher.json").getTestDataAsMap("$");
        testData = new JSONFileManager(System.getProperty("testDataFolderPath") + "KableDeutschland/ST/WFCT_13054.json");
    }


    @Test(description = "WFCT_13054 | GC01 - Martin user checks the itemized bill section in the einstellungen tab",enabled = false)
    @TmsLink("WFCT-13057")
    ...
    @Test(description = "WFCT_13054 | GC02 - Martin user with 'Shortened by the last 3 digits'Itemized bill checks einstellungen tab",enabled = false)
    @TmsLink("WFCT-13088")
    public void GC02_MartinUserWithShortenedLast3DigitsItemizedBillChecksEinstellungenTab() {
        dashboard.clickMeineRechnungenTile();
        meineRechnungen.clickEinstellungenTab();
        einstellungen.assertOnPageHeader();
        einstellungen.assertOnPageSubTitle();
    ...
    @Test(description = "WFCT_13054 | GC03 - Martin user with 'No' Itemized bill checks einstellungen tab",enabled = false)
    @TmsLink("WFCT-13089")
    public void GC03_MartinUserWithNoItemizedBillChecksEinstellungenTab() {
        dashboard.clickMeineRechnungenTile();
        meineRechnungen.clickEinstellungenTab();
        einstellungen.assertOnPageHeader();
        einstellungen.assertOnPageSubTitle();
