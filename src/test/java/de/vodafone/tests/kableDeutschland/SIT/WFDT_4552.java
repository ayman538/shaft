...
@Feature("SIT")
@Story("WFDT_4552")
public class WFDT_4552 extends SIT_KableDeutschlandSetup {
    @TmsLink("WFDT-5393")
    ...
    @TmsLink("WFDT-5396")
    @Test(description = "GC03 || Martin - Verify Login-Daten section with given and validated Login e-Mail address",groups = {"eCare"})
    private void gc03(){
        new Dashboard(driver).openMeineKundenDatenTile(Dashboard.DashboardSmartObject.MEINEKUNDENDATEN);
        new MeineDaten(driver).clickOnSmartObject(MeineDaten.MeineDatenSmartObjects.KONTAKTDATEN);
    }
